...
function Compare() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Compare Countries</h1>
        <p className="text-gray-600">Select multiple countries to compare their trajectories</p>
      </div>

      {/* Country Selection */}
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
        <h2 className="text-xl font-bold mb-4">Select Countries (All {countries.length} Available)</h2>
        ...
        {selectedCountries.length > 0 && (
          <div className="mt-4">
            <p className="text-sm font-medium mb-2">Selected ({selectedCountries.length}):</p>
        ...
        <>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold mb-4 text-gray-800">GDP Comparison (B USD)</h2>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold mb-4 text-gray-800">Population Comparison (M)</h2>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold mb-4 text-gray-800">Military Expenditure (B USD)</h2>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold mb-4 text-gray-800">Global Superpower Index (GSI)</h2>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-2xl font-bold mb-4">2050 Projection Comparison</h2>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Country</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">GDP (B USD)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Population (M)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Military (B USD)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">GSI Score</th>
                  </tr>
                </thead>
                    ...
                    <tr key={country.iso}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <span className="text-sm font-medium text-gray-900">{country.gsi.toFixed(4)}</span>
      ...
      {selectedCountries.length === 0 && !loading && (
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          <p className="text-gray-500">Select countries from above to start comparing</p>
        </div>
      )}
    </div>
  )
